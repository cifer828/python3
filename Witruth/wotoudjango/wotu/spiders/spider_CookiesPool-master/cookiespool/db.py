...
if __name__ == '__main__':
    ...
    """
    # 测试
    conn = AccountRedisClient(name='qcc')
    #conn.set('513520438', '1201qq0533')
    conn.set('2277607306', '3333322222')
    conn.set('2337769509', 'zhichengziben')
    conn.set('546263718', 'dafengge')
    #conn.set('3478352529', 'zz666666 ')
    print((conn.get('2337769509')))
    print((list(conn.keys())))
    accounts = conn.all()
