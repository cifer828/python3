...
def main():
  ...
  # camera = cv2.VideoCapture(path.join(path.dirname(__file__), "D:/文档/研究生/研二/交通行为参数提取/数据/交叉口视频/test1.avi"))
  # camera = cv2.VideoCapture(path.join(path.dirname(__file__), "..", "movie.mpg"))
  camera = cv2.VideoCapture('C:\\Users\zhqch\Documents\code\Python3Projects\\visual_detection\\tracker\surveillance_demo\\768x576.avi')
