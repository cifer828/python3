...
train = True
# 模型文件路径
model_path = "C:/Users/zhqch/Documents/code/Python3Projects/ai_group/Tensorflow-CNN-Tutorial-master/model/image_model"
...
def read_data2(categories, training = True):
    """
    ...
    with open(txt) as f:
        ...
        for idx, line in enumerate(txt_data):
            ...
            if label in categories:
                ...
                cv2.imwrite('mydata/%d_%d.jpg'% (label, idx), im)
...
read_data2([6,7,8,9,10,11])
# fpaths, datas, labels = read_data('data')
fpaths, datas, labels = read_data('mydata')
